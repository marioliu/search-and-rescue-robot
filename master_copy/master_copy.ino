...
// distance sensor in the left
#define trigPinL 6
#define echoPinL 5

// distance sensor in the right
#define trigPinR 4
#define echoPinR 3

// distance sensor in the back
#define trigPinB 2
#define echoPinB 1
...
int leftDistanceReadings[numReadings];
int leftDistanceTotal = 0;
int leftDistanceAverage = 0;

int rightDistanceReadings[numReadings];
int rightDistanceTotal = 0;
int rightDistanceAverage = 0;

long durationL, distanceL, durationR, distanceR, durationB, distanceB;
...
// Timer for backwheels
long startTime;
long elapsedTime;

// setup for the light sensors
int tolerance = 200; // the tolerance between light values
const long distTolerance = 5.0; // tolerance between dist sensors
long error = 0.0; // error between sensors

const int lightL = A4;  // Analog input pin that the LEFT light pin is connected to
const int lightR = A5; // Analog input pin that the RIGHT light pin is connected to
...
int RightSpeedBack = 1380;

int LeftSpeedBack = 1620;
...
void setup() {
  ...
  pinMode(trigPinB, OUTPUT); // back
  pinMode(echoPinB, INPUT); // back
  pinMode(sigPin, INPUT); // signal pin
